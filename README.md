...
Using single-cell RNA-seq and ATAC-seq data to understand how gene regulatory networks change during dynamic processes during [development](https://github.com/Roy-lab/MERLIN-SUITE) and disease. I was a contributing author to a [recent review](https://www.annualreviews.org/content/journals/10.1146/annurev-genom-120922-103729) that synthesizes current approaches for modeling dynamic gene regulatory networks using single-cell multi-omics data.
